...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv_in_buf_V_0_address0 { O 7 vector } conv_in_buf_V_0_ce0 { O 1 bit } conv_in_buf_V_0_we0 { O 1 bit } conv_in_buf_V_0_d0 { O 16 vector } } \
} "
} else {
