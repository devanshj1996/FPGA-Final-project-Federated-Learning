set moduleName tiled_conv_Pipeline_INPUT_BUFFER_HEIGHT_INPUT_BUFFER_WIDTH
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {tiled_conv_Pipeline_INPUT_BUFFER_HEIGHT_INPUT_BUFFER_WIDTH}
...
set portList { 
	...
	{ trunc_ln2 sc_in sc_lv 3 signal 2 } 
	{ conv_in_buf_V_0_address0 sc_out sc_lv 7 signal 3 } 
	{ conv_in_buf_V_0_ce0 sc_out sc_logic 1 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln2", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "trunc_ln2", "role": "default" }} , 
